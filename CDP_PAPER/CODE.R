...
data_1 <- read.csv('/scratch/ope4/CPD_PAPER/Band_Values_POLY_1-001.csv')

data_3 <- read.csv('/scratch/ope4/CPD_PAPER/Band_Values_POLY_3-001.csv')
...
data <- read.csv('/scratch/ope4/CPD_PAPER/Band_Values_POLY_Monica.csv')
